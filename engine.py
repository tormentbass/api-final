...
# ARQUIVO: engine.py
# VERSÃO: 1.0.0
# DATA: 06/12/2025 - 11:55h
# AUTOR: Plínio + Engenharia ChatGPT
#
# DESCRIÇÃO:
#     - Motor de análise do sistema.
#     - Carrega modelo ML, histórico e features.
#     - Gera previsões, rankings e análises estatísticas.
#     - Arquitetura segura para Render, Supabase e Lovable.
#
# AVISO:
#     Carregamento executado automaticamente na importação do arquivo.
# ====================================================================================================
...
# ====================================================================================================
# CONSTANTES DE ARQUIVOS (paths fixos para Render e Github)
# ====================================================================================================
...
def carregar_componentes():
    """Carrega o modelo, features e histórico apenas 1 vez por ciclo."""
    global model, features_finais, df_historico

    print("\n========== [ENGINE] INICIANDO CARREGAMENTO ==========")

    # Logs de existência dos arquivos
    ...
    try:
        ...
        print("[ENGINE] Modelo carregado.")

        # Features
        features_finais = joblib.load(FEATURES_PATH)
        print(f"[ENGINE] Features carregadas: {len(features_finais)} features.")
...
# ====================================================================================================
# CARREGAMENTO AUTOMÁTICO NA IMPORTAÇÃO
# ====================================================================================================
